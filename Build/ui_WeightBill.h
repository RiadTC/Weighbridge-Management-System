...
public:
    ...
    void setupUi(QDialog *WeightBill)
    {
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), WeightBill, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), WeightBill, SLOT(reject()));
    ...
    {
        WeightBill->setWindowTitle(QApplication::translate("WeightBill", "Dialog", nullptr));
        label->setText(QApplication::translate("WeightBill", "Customer :", nullptr));
        label_3->setText(QApplication::translate("WeightBill", "Material", nullptr));
        label_2->setText(QApplication::translate("WeightBill", "Transporter :", nullptr));
        label_4->setText(QApplication::translate("WeightBill", "Vehicule", nullptr));
    } // retranslateUi
