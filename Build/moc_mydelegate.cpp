...
#include "../Weighbridge/Other/mydelegate.h"
...
QT_INIT_METAOBJECT const QMetaObject MyDelegate::staticMetaObject = { {
    &QStyledItemDelegate::staticMetaObject,
    qt_meta_stringdata_MyDelegate.data,
    qt_meta_data_MyDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
