...
public:
    ...
    void setupUi(QDialog *OperatorDialog)
    {
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, OperatorDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, OperatorDialog, qOverload<>(&QDialog::reject));
    ...
    {
        OperatorDialog->setWindowTitle(QCoreApplication::translate("OperatorDialog", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("OperatorDialog", "Operator : ", nullptr));
        leOperatorName->setInputMask(QString());
        label_2->setText(QCoreApplication::translate("OperatorDialog", "Password : ", nullptr));
        leOperatorPass->setInputMask(QString());
        label_3->setText(QCoreApplication::translate("OperatorDialog", "Confirm Password : ", nullptr));
