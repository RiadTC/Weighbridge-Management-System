...
public:
    ...
    void setupUi(QDialog *Indicator)
    {
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, Indicator, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, Indicator, qOverload<>(&QDialog::reject));
    ...
    void retranslateUi(QDialog *Indicator)
    {
        ...
        label->setText(QCoreApplication::translate("Indicator", "Stream Length:", nullptr));
        label_2->setText(QCoreApplication::translate("Indicator", "Delimiter:", nullptr));
    } // retranslateUi
